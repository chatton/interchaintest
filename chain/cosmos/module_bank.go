...
func (c *Chain) BankQueryBalance(ctx context.Context, address string, denom string) (sdkmath.Int, error) {
...
func (c *Chain) BankQueryAllBalances(ctx context.Context, address string) (types.Coins, error) {
...
func (c *Chain) BankQueryDenomMetadata(ctx context.Context, denom string) (*banktypes.Metadata, error) {
...
func (c *Chain) BankQueryDenomMetadataByQueryString(ctx context.Context, denom string) (*banktypes.Metadata, error) {
...
func (c *Chain) BankQueryDenomOwners(ctx context.Context, denom string) ([]*banktypes.DenomOwner, error) {
...
func (c *Chain) BankQueryDenomsMetadata(ctx context.Context) ([]banktypes.Metadata, error) {
...
func (c *Chain) BankQueryParams(ctx context.Context) (*banktypes.Params, error) {
	res, err := banktypes.NewQueryClient(c.GetNode().GrpcConn).Params(ctx, &banktypes.QueryParamsRequest{})
	return &res.Params, err
}

func (c *Chain) BankQuerySendEnabled(ctx context.Context, denoms []string) ([]*banktypes.SendEnabled, error) {
...
func (c *Chain) BankQuerySpendableBalance(ctx context.Context, address, denom string) (*types.Coin, error) {
...
func (c *Chain) BankQuerySpendableBalances(ctx context.Context, address string) (*types.Coins, error) {
...
func (c *Chain) BankQueryTotalSupply(ctx context.Context) (*types.Coins, error) {
...
func (c *Chain) BankQueryTotalSupplyOf(ctx context.Context, address string) (*types.Coin, error) {
